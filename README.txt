...
db.questions.insert({title: "JPA True False", quizId: "234", question:"JPA stands for Java Persistence API", correct: "true", type: "TRUE_FALSE"})
db.questions.insert({title: "JPA Multiple Choice", quizId: "234", question:"What does JPA stand for?", correct: "Java Persistence API",type: "MULTIPLE_CHOICE", choices:["Java Pseudo API", "Java Persistence API", "JSON Persistence API","JavaScript Persistence API"]})
db.questions.insert({title: "JSON True False", quizId: "234", question:"JSON stands for Java Object Notation", correct: "false",type: "TRUE_FALSE"})
db.questions.insert({title: "JSON Multiple Choice", quizId: "345", question:"What does JSON stand for?", correct: "JavaScript Object Notation",type: "MULTIPLE_CHOICE", choices: ["JavaScript Object Notation","JavaScript Object Normalization", "Java Object Normalization", "Java Object Notation"]})
db.questions.insert({title: "CSS True False", quizId: "345", question:"CSS stands for Cascading Style Sheet", correct: "true", type: "TRUE_FALSE"},{_id: "678", title: "CSS Multiple Choice", quizId: "123", question:"What does CSS stand for?", correct: "Cascading Style Sheet", type:"MULTIPLE_CHOICE", choices: ["Class Style Sheet", "Cascading Screen Style","Cascading Style Sheet", "Cascading Style Screen"]})
db.questions.insert({title: "CSS Multiple Choice", quizId: "123", question:"What does CSS stand for?", correct: "Cascading Style Sheet", type:"MULTIPLE_CHOICE", choices: ["Class Style Sheet", "Cascading Screen Style", "Cascading Style Sheet", "Cascading Style Screen"]})
